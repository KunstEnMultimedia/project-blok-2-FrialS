...
<body background="iconen/achtergrond.png"></body>
    ...
    <main>
        ...
        <form class="zoekbalk" method="POST" action="/index.php?search=" style="margin:auto;max-width:536px">
            <input type="text" placeholder="ingrediënt, recept, keyword " name="search">
          ...
          <div class="zoekbalk-versiering">
              <img src="iconen/versierselzoekbalk.png">
          </div>
            ...
            <div class="row">
              <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">1. Meng de cre?me frai?che met de mayonaise, ketchup en whisky tot cocktailsaus. Breng op smaak met het citroensap, de tabasco, peper en eventueel zou..</p>
              ...
              <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">1. Schil de aardappelen, snijd ze in gelijke stukken en snipper de uien grof. Schil de goudrenetten, verwijder het klokhuis en snijd het vruchtvlees i..</p>
              ...
              <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">1. Snijd de snijbonen in schuine, dunne plakjes. Breng een pan water met zout aan de kook en kook ze in 6 min. beetgaar. Giet af. 2. Doe de cannell..</p>
